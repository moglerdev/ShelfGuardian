...
class DatePicker extends StatelessWidget {
  ...
  ///
  /// The [setDate] parameter is a callback function that will be called when a date is selected.
  /// The [date] parameter is the initial date to display in the date picker.
  const DatePicker({
    super.key,
