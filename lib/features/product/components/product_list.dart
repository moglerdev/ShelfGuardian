...
class ProductList extends StatelessWidget {
  ...
  /// Constructs a [ProductList] widget.
  ///
  /// The [products] parameter is a list of products to display.
  /// The [selectedProducts] parameter is a list of selected products.
  /// The [onSelectChanged] parameter is a callback function that is called when the selection changes.
  const ProductList({
    super.key,
              ...
              child: ProductItem(
                ...
                onTap: () async {
                  if (selectedProducts.isNotEmpty) {
                    ...
                    await router.push(NavigationServiceRoutes.editRouterUri
